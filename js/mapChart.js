...
function geoSvg(){
    ...
    var svgAsXML = (new XMLSerializer).serializeToString(document.getElementsByTagName('svg')[1]);
    var svgData = "data:image/svg+xml," + encodeURIComponent(svgAsXML);
    document.getElementById('svg-geo-chart').outerHTML = '<a id  = "geo-btn-svg" href="' + svgData + '" download="USA_MAP.svg" target="_blank">Convert to SVG</a>';
}
