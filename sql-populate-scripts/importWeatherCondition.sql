...
BEGIN
	...
	SET @i = @i+1;
        ...
        SELECT COUNT(*) INTO @pressureBelowTenValue FROM us_accidents u WHERE u.state LIKE @item AND u.pressure < 20;
        SELECT COUNT(*) INTO @pressureBelowTwentyValue FROM us_accidents u WHERE u.state LIKE @item AND u.pressure < 30 AND u.pressure >= 20;
        SELECT COUNT(*) INTO @pressureAboveTwentyValue FROM us_accidents u WHERE u.state LIKE @item AND u.pressure >= 30;
        SELECT COUNT(*) INTO @visibilityBelowThirtyValue FROM us_accidents u WHERE u.state LIKE @item AND u.visibility < 10;
        SELECT COUNT(*) INTO @visibilityBelowSixtyValue FROM us_accidents u WHERE u.state LIKE @item AND u.visibility < 20 AND u.visibility >= 10;
        SELECT COUNT(*) INTO @visibilityBelowHundredValue FROM us_accidents u WHERE u.state LIKE @item AND u.visibility < 30 AND u.visibility >= 20;
        SELECT COUNT(*) INTO @visibilityAboveHundredValue FROM us_accidents u WHERE u.state LIKE @item AND u.visibility >= 30;
        SELECT COUNT(*) INTO @windSpeedBelowThirtyValue FROM us_accidents u WHERE u.state LIKE @item AND u.wind_speed < 5;
        SELECT COUNT(*) INTO @windSpeedBelowSixtyValue FROM us_accidents u WHERE u.state LIKE @item AND u.wind_speed < 10 AND u.wind_speed >= 5;
        SELECT COUNT(*) INTO @windSpeedBelowHundredValue FROM us_accidents u WHERE u.state LIKE @item AND u.wind_speed < 20 AND u.wind_speed >= 10;
        SELECT COUNT(*) INTO @windSpeedBelowTwoHundredValue FROM us_accidents u WHERE u.state LIKE @item AND u.wind_speed < 30 AND u.wind_speed >= 20;
        SELECT COUNT(*) INTO @windSpeedBelowThreeHundredValue FROM us_accidents u WHERE u.state LIKE @item AND u.wind_speed < 50 AND u.wind_speed >= 30;
        SELECT COUNT(*) INTO @windSpeedAboveThreeHundredValue FROM us_accidents u WHERE u.state LIKE @item AND u.wind_speed >= 50;
