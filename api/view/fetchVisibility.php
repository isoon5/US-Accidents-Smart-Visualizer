...
$result = $weather->getVisibility($state);
...
while($row = $result->fetch(PDO::FETCH_ASSOC)){
    ...
    $arrayTemp = array(
        ...
        'name' => $state,
        'belowThirty' => $visibilityBelowThirty,
        'belowSixty' => $visibilityBelowSixty,
        'belowHundred' => $visibilityBelowHundred,
        'aboveHundred' => $visibilityAboveHundred
